...
export default function Policy() {
  ...
  const sections = [
    { id: 'section1', title: 'Вводная информация и законодательная база' },
    { id: 'section2', title: 'Словарь используемых терминов' },
    { id: 'section3', title: 'Правила работы и ответственность Оператора' },
    { id: 'section4', title: 'Ваши права как субъекта данных' },
    { id: 'section5', title: 'Этические и правовые стандарты обработки' },
    { id: 'section6', title: 'Перечень собираемых данных и цели' },
    { id: 'section7', title: 'Правовые основания для работы с информацией' },
    { id: 'section8', title: 'Как мы храним и защищаем ваши данные' },
    { id: 'section9', title: 'Технические процессы обработки' },
    { id: 'section10', title: 'Передача данных за пределы страны' },
    { id: 'section11', title: 'Гарантии неразглашения' },
    { id: 'section12', title: 'Контакты для связи и обновления документа' },
  ];
    ...
    <div className="min-h-screen bg-[#faf7ec] relative">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-[rgba(250,247,236,0.8)] border-b border-[rgba(45,54,37,0.1)]">
        <div className="max-w-[1400px] mx-auto px-8 py-6 flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-[#2d3625]">Политика конфиденциальности</h1>
        </div>
      </header>
        ...
        <div className="flex gap-8 relative">
          ...
          <main className="flex-1 min-w-0">
            <div className="backdrop-blur-[20px] bg-[rgba(255,255,255,0.4)] rounded-[20px] p-12 shadow-lg border border-[rgba(255,255,255,0.8)]">
              {/* Section 1 */}
              <section id="section1" className="mb-16 scroll-mt-32">
              ...
              {/* Section 2 */}
              <section id="section2" className="mb-16 scroll-mt-32">
                <h2 className="text-3xl font-bold text-[#2d3625] mb-6">
                  2. Основные понятия, используе��ые в Политике
                </h2>
                <div className="space-y-4 text-[#1f2937] leading-[1.6]">
                  <div>
                    <p className="mb-2">
                      <strong>2.1.</strong> Автоматизированная обработка персональных данных — обработка
                  ...
                  <div>
                    <p className="mb-2">
                      <strong>2.3.</strong> Веб-сайт — совокупность графических и информационных материалов, а
                  ...
                  <div>
                    <p className="mb-2">
                      <strong>2.4.</strong> Информационная система персональных данных — совокупность содержащихся
                  ...
                  <div>
                    <p className="mb-2">
                      <strong>2.5.</strong> Обезличивание персональных данных — действия, в результате которых
                  ...
                  <div>
                    <p className="mb-2">
                      <strong>2.6.</strong> Обработка персональных данных — любое действие (операция) или
                  ...
                  <div>
                    <p className="mb-2">
                      <strong>2.11.</strong> Предоставление персональных данных — действия, направленные на
                  ...
                  <div>
                    <p className="mb-2">
                      <strong>2.13.</strong> Трансграничная передача персональных данных — передача персональных
